...
class DeepSurv:
    ...
    standardize = False,
        ...
        #     layers.append(nn.BatchNorm1d(size_list[i+1], eps=1e-05, momentum=0.1, affine=True, track_running_stats=True))
        ...
        for i in range(len(hidden_layers_sizes)):
            ...
            if batch_norm:
                ...
                self.layers.append(nn.BatchNorm1d(hidden_layers_sizes[i], eps=1e-05, momentum=momentum, affine=True, track_running_stats=True))
